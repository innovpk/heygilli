...
demo at `/try`), the gateway on Render with DynamoDB storage and Bedrock models. Render's free
...
**Verified:** 666 backend tests and 615 client tests, both offline; `flutter analyze` clean. The
